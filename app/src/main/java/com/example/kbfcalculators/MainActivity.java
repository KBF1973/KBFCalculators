...
public class MainActivity extends AppCompatActivity {
    ...
    public void tempOnClick(View v){
        Intent i = new Intent(this, TempCalculator.class);
        startActivity(i);

    }

    public void distanceOnlick(View v){
        Intent i = new Intent(this, DistanceCalculator.class);
        startActivity(i);
    }
